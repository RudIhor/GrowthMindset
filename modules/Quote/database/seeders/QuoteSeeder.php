...
class QuoteSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $quotes = [
            ...
            ["Never give up on something you really want. It's difficult to wait, but it's more difficult to regret", 18, 1],
            ...
            ['Sometimes courage is the quiet voice at the end of the day saying: I will try tomorrow', null, 3],
            ['The pain you feel today will be the strength you feel tomorrow', 1, 3],
            ["If you don't value your time, neither will others", null, 5],
            ['Get up! Otherwise your comfort zone will kill you.', null, 3],
